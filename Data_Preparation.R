...
write.csv2(x=co_wst,file = 'data/weather_station_coordinate.csv')

co_wst = as.data.frame(t(co_wst))
write.csv2(co_wst,'data/weather_station_coordinate_transposed.csv') #Pour Arcgis
